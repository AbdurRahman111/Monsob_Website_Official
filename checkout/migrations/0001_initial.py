    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Order_Time', models.DateTimeField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 50, 919916))),
                ('Paid_Time', models.DateTimeField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 50, 919932))),
                ('Order_Date', models.DateField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 50, 919941))),
                ('Paid_Date', models.DateField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 50, 919949))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logs_time', models.DateTimeField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 50, 922094))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('logs_status', models.TextField(blank=True, null=True)),
                ('logs_time', models.DateTimeField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 50, 922463))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Order_Date', models.DateField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 50, 920745))),
