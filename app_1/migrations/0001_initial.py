    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Brand_logo', models.ImageField(blank=True, help_text='Choose Only .jpg, .jpeg, .png, .webp files PLease..', null=True, upload_to='Brand_logo/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg', 'webp'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 800312), null=True)),
                ('end_time', models.DateField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 800325), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Category_benner', models.FileField(blank=True, help_text='Choose Only .jpg, .jpeg, .png, .webp and files PLease..', null=True, upload_to='Category_benner', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg', 'webp'])])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flash_sell_start_time', models.DateField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 799643))),
                ('flash_sell_end_time', models.DateField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 799655))),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='', null=True, upload_to='staff_pics/')),
                ...
                ('First_Register_Time', models.DateTimeField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 799924))),
                ('Last_login_Time', models.DateTimeField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 799935))),
                ('product_upload_qty', models.IntegerField(blank=True, default=0, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Time', models.DateTimeField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 796656))),
                ('make_star', models.BooleanField(default=False)),
                ('flash_sell', models.BooleanField(default=False)),
                ('flash_sell_start_time', models.DateField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 796682))),
                ('flash_sell_end_time', models.DateField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 796692))),
                ...
                ('who_add_this', models.CharField(blank=True, default='', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Review_Time', models.DateTimeField(blank=True, default=datetime.datetime(2023, 12, 21, 17, 9, 25, 798557))),
